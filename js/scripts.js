    ...
    course1: {
        questions: [
            ...
            },
            {
                ...
                answers: [
                    { text: "Data Minimisation", correct: true },
                    { text: "Data Maximisation", correct: false },
                    { text: "Data Centralisation", correct: false },
                    { text: "Data Monetisation", correct: false }
                ]
            },
            {
                question: "Who does GDPR apply to?",
                answers: [
                    { text: "Organisations operating within the EU", correct: true },
                    { text: "Only EU citizens", correct: false },
                    { text: "Only organisations based in the EU", correct: false },
                    { text: "Only government organisations", correct: false }
                ]
            },
            {
            ...
            },
            {
                ...
                answers: [
                    ...
                    { text: "To maximise data collection", correct: false },
                    { text: "To centralise data storage", correct: false },
                    { text: "To monetise personal data", correct: false }
                ]
            },
            {
        ...
        questions: [
            {
                ...
                answers: [
                    ...
                    { text: "Personal data must be monetised", correct: false }
                ]
            },
            {
    ...
    course3: {
        questions: [
            ...
            },
            {
                ...
                answers: [
                    { text: "The right to transfer personal data to another organisation", correct: true },
                    { text: "The right to access personal data", correct: false },
            ...
            },
            {
                ...
                answers: [
                    { text: "Organisations must be able to demonstrate compliance with GDPR", correct: true },
                    { text: "Organisations must centralise data storage", correct: false },
                    { text: "Organisations must maximise data collection", correct: false },
                    { text: "Organisations must monetise personal data", correct: false }
                ]
            },
            {
                question: "What is the principle of integrity and confidentiality?",
